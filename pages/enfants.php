...
<html lang="fr-FR">
    <head>
        <title>Enfants Casques Nolark : Sécurité et confort, nos priorités !</title>
        <meta charset="UTF-8">
        <meta name="author" content="José GIL">
        <meta name="description" content="Vous êtes dans la catégorie des casques enfants. Tous les casques Nolark au meilleur prix et avec en prime la livraison gratuite !">
    ...
    <body>
        ...
        <section id="video">
            <article>
                ...
                <p>
                    Et pourtant, certains omettent l'essentiel : <span>Attacher son <strong>casque</strong> !</span>
                </p>
                <p>
